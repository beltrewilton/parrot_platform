defmodule ParrotSip.Headers.ViaTest do
  use ExUnit.Case
  ...
  describe "formatting Via header lists" do
    ...
    test "formats single Via header in list" do
      ...
      assert Headers.Via.format_list([via]) ==
               "SIP/2.0/UDP proxy.example.com:5060;branch=z9hG4bK776asdhds"
    end
    ...
    test "formats multiple Via headers in list" do
      ...
      expected =
        "SIP/2.0/UDP proxy1.example.com:5060;branch=z9hG4bK776asdhds, " <>
    ...
    test "formats list with IPv4 and IPv6 addresses" do
      ...
      expected =
        "SIP/2.0/UDP 192.168.1.1:5060;branch=z9hG4bK111, " <>
    ...
    test "formats list with Via headers containing multiple parameters" do
      via1 =
        Headers.Via.new("proxy1.com", "udp", 5060, %{
          "branch" => "z9hG4bK111",
          "received" => "10.0.0.1",
          "rport" => "5555"
        })
      ...
      via2 =
        Headers.Via.new("proxy2.com", "tcp", nil, %{
          "branch" => "z9hG4bK222",
          "maddr" => "239.255.255.1"
        })
