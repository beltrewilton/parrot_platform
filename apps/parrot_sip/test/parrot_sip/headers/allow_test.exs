defmodule ParrotSip.Headers.AllowTest do
  use ExUnit.Case
  ...
  describe "parsing Allow headers" do
    test "parses Allow header" do
      ...
      assert allow == ParrotSip.MethodSet.new([:invite, :ack, :cancel, :options, :bye])
  ...
  describe "creating Allow headers" do
    test "creates Allow header" do
      expected = ParrotSip.MethodSet.new([:invite, :ack, :cancel, :options, :bye])
