defmodule ParrotSip.AuthTest do
  ...
  describe "create_authorization/6" do
    ...
    test "creates authorization with MD5 algorithm", %{challenge: challenge} do
      ...
      assert String.length(auth.response) == 32 # MD5 hex is 32 chars
    end
  ...
  describe "validate_authorization/3" do
    ...
    test "rejects incorrect password" do
      ...
      assert {:error, :invalid_credentials} = Auth.validate_authorization(auth, :register, "wrong")
    end
    ...
    test "rejects if method doesn't match" do
      ...
      assert {:error, :invalid_credentials} = Auth.validate_authorization(auth, :invite, "secret123")
    end
  end
  ...
  describe "parse_auth_header/1" do
    ...
    test "parses header with all parameters" do
      header = ~s(Digest username="alice", realm="atlanta.com", nonce="dcd98b7102dd2f0e8b11d0f600bfb0c093", uri="sip:atlanta.com", response="6629fae49393a05397450978507c4ef1", algorithm=MD5, cnonce="0a4f113b", opaque="5ccc069c403ebaf9f0171e9517f40e41", qop=auth, nc=00000001)
  ...
  describe "MD5 response calculation" do
    test "calculates correct response without qop (RFC 2617 example)" do
      ...
      auth = Auth.create_authorization(
        :get,  # Using GET to match HTTP example
        "/dir/index.html",
        challenge,
        "Mufasa",
        "Circle Of Life"
    ...
    test "calculates consistent responses" do
      ...
      auth1 = Auth.create_authorization(
        :register,
        "sip:atlanta.com",
        challenge,
        "alice",
      ...
      auth2 = Auth.create_authorization(
        :register,
        "sip:atlanta.com",
        challenge,
        "alice",
