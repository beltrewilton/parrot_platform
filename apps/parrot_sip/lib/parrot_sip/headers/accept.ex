defmodule ParrotSip.Headers.Accept do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Accept.new("application", "sdp")
      %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{}, q_value: nil}
      
      iex> ParrotSip.Headers.Accept.new("application", "sdp", %{"charset" => "UTF-8"}, 0.8)
      %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{"charset" => "UTF-8"}, q_value: 0.8}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Accept.parse("application/sdp")
      %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{}, q_value: nil}
      
      iex> ParrotSip.Headers.Accept.parse("application/sdp;charset=UTF-8;q=0.8")
      %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{"charset" => "UTF-8"}, q_value: 0.8}
  """
  ...
  ## Examples
      ...
      iex> accept = %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{}, q_value: nil}
      iex> ParrotSip.Headers.Accept.format(accept)
      "application/sdp"
      
      iex> accept = %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{"charset" => "UTF-8"}, q_value: 0.8}
      iex> ParrotSip.Headers.Accept.format(accept)
  ...
  ## Examples
      ...
      iex> accept = %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{}, q_value: nil}
      iex> ParrotSip.Headers.Accept.to_string(accept)
      "application/sdp"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Accept.sdp()
      %ParrotSip.Headers.Accept{type: "application", subtype: "sdp", parameters: %{}, q_value: nil}
  """
  @spec sdp() :: t()
  def sdp() do
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Accept.all()
      %ParrotSip.Headers.Accept{type: "*", subtype: "*", parameters: %{}, q_value: nil}
  """
  @spec all() :: t()
  def all() do
    new("*", "*")
