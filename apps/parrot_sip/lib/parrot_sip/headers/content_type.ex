defmodule ParrotSip.Headers.ContentType do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentType.new("application", "sdp")
      %ParrotSip.Headers.ContentType{type: "application", subtype: "sdp", parameters: %{}}
      
      iex> ParrotSip.Headers.ContentType.new("multipart", "mixed", %{"boundary" => "boundary42"})
      %ParrotSip.Headers.ContentType{type: "multipart", subtype: "mixed", parameters: %{"boundary" => "boundary42"}}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentType.parse("application/sdp")
      %ParrotSip.Headers.ContentType{type: "application", subtype: "sdp", parameters: %{}}
      
      iex> ParrotSip.Headers.ContentType.parse("multipart/mixed; boundary=boundary42")
      %ParrotSip.Headers.ContentType{type: "multipart", subtype: "mixed", parameters: %{"boundary" => "boundary42"}}
  ...
  ## Examples
      ...
      iex> content_type = %ParrotSip.Headers.ContentType{type: "application", subtype: "sdp", parameters: %{}}
      iex> ParrotSip.Headers.ContentType.format(content_type)
      "application/sdp"
      
      iex> content_type = %ParrotSip.Headers.ContentType{type: "multipart", subtype: "mixed", parameters: %{"boundary" => "boundary42"}}
      iex> ParrotSip.Headers.ContentType.format(content_type)
  ...
  ## Examples
      ...
      iex> content_type = %ParrotSip.Headers.ContentType{type: "application", subtype: "sdp", parameters: %{}}
      iex> ParrotSip.Headers.ContentType.media_type(content_type)
      "application/sdp"
  ...
  ## Examples
      ...
      iex> content_type = %ParrotSip.Headers.ContentType{type: "multipart", subtype: "mixed", parameters: %{"boundary" => "boundary42"}}
      iex> ParrotSip.Headers.ContentType.parameters(content_type)
      %{"boundary" => "boundary42"}
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentType.create("multipart/mixed", %{"boundary" => "boundary42"})
      %ParrotSip.Headers.ContentType{type: "multipart", subtype: "mixed", parameters: %{"boundary" => "boundary42"}}
