defmodule ParrotSip.Headers.To do
  @moduledoc """
  ...
  def format(to) do
    ...
    uri_part =
      cond do
        is_struct(to.uri, ParrotSip.Uri) ->
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.To.parse("Bob <sip:bob@biloxi.com>;tag=a6c85cf")
      %ParrotSip.Headers.To{display_name: "Bob", uri: %ParrotSip.Uri{scheme: "sip", user: "bob", host: "biloxi.com"}, parameters: %{"tag" => "a6c85cf"}}
      
      iex> ParrotSip.Headers.To.parse("<sip:bob@biloxi.com>")
      %ParrotSip.Headers.To{display_name: nil, uri: %ParrotSip.Uri{scheme: "sip", user: "bob", host: "biloxi.com"}, parameters: %{}}
