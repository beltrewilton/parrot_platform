defmodule ParrotSip.Headers.ContentLength do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentLength.new(42)
      %ParrotSip.Headers.ContentLength{value: 42}
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentLength.parse("42")
      %ParrotSip.Headers.ContentLength{value: 42}
  ...
  ## Examples
      ...
      iex> content_length = %ParrotSip.Headers.ContentLength{value: 42}
      iex> ParrotSip.Headers.ContentLength.format(content_length)
      "42"
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentLength.calculate("Hello, world!")
      13
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ContentLength.create("Hello, world!")
      %ParrotSip.Headers.ContentLength{value: 13}
