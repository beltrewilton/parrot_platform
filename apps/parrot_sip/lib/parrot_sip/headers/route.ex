defmodule ParrotSip.Headers.Route do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Route.new("sip:proxy.example.com;lr")
      %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.Route.new("sip:proxy.example.com;lr", "Example Proxy")
      %ParrotSip.Headers.Route{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Route.parse("<sip:proxy.example.com;lr>")
      %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.Route.parse("Example Proxy <sip:proxy.example.com;lr>")
      %ParrotSip.Headers.Route{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.Route.parse("\"Complex Name\" <sip:proxy.example.com;lr>;param=value")
      %ParrotSip.Headers.Route{display_name: "Complex Name", uri: "sip:proxy.example.com;lr", parameters: %{"param" => "value"}}
  """
  ...
  ## Examples
      ...
      iex> route = %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      iex> ParrotSip.Headers.Route.format(route)
      "<sip:proxy.example.com;lr>"
      
      iex> route = %ParrotSip.Headers.Route{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
      iex> ParrotSip.Headers.Route.format(route)
      "Example Proxy <sip:proxy.example.com;lr>"
      
      iex> route = %ParrotSip.Headers.Route{display_name: "Complex Name", uri: "sip:proxy.example.com;lr", parameters: %{"param" => "value"}}
      iex> ParrotSip.Headers.Route.format(route)
  ...
  def format(route) do
    ...
    uri_part =
      cond do
        is_struct(route.uri, ParrotSip.Uri) ->
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Route.parse_list("<sip:proxy1.example.com;lr>, <sip:proxy2.example.com;lr>")
      [
        %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy1.example.com;lr", parameters: %{}},
        %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy2.example.com;lr", parameters: %{}}
      ]
  """
  ...
  ## Examples
      ...
      ...>   %ParrotSip.Headers.Route{display_name: nil, uri: "sip:proxy2.example.com;lr", parameters: %{}}
      ...> ]
      iex> ParrotSip.Headers.Route.format_list(routes)
