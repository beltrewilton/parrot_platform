defmodule ParrotSip.Headers.Subject do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Subject.new("Project X Discussion")
      %ParrotSip.Headers.Subject{value: "Project X Discussion"}
  """
  @spec new(String.t()) :: t()
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Subject.parse("Project X Discussion")
      %ParrotSip.Headers.Subject{value: "Project X Discussion"}
  """
  ...
  ## Examples
      ...
      iex> subject = %ParrotSip.Headers.Subject{value: "Project X Discussion"}
      iex> ParrotSip.Headers.Subject.format(subject)
  ...
  ## Examples
      ...
      iex> subject = %ParrotSip.Headers.Subject{value: "Project X Discussion"}
      iex> ParrotSip.Headers.Subject.to_string(subject)
      "Project X Discussion"
  """
