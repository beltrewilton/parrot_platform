defmodule ParrotSip.Headers.Contact do
  @moduledoc """
  ...
  def format(contact) do
    if contact.wildcard do
      ...
      uri_part =
        cond do
          is_struct(contact.uri, ParrotSip.Uri) ->
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Contact.parse("Alice <sip:alice@pc33.atlanta.com>;expires=3600")
      %ParrotSip.Headers.Contact{display_name: "Alice", uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "pc33.atlanta.com"}, parameters: %{"expires" => "3600"}, wildcard: false}
      
      iex> ParrotSip.Headers.Contact.parse("*")
      %ParrotSip.Headers.Contact{display_name: nil, uri: nil, parameters: %{}, wildcard: true}
