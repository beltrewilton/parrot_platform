defmodule ParrotSip.Headers.MaxForwards do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.new(70)
      70
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.default()
      70
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.parse("70")
      70
      
      iex> ParrotSip.Headers.MaxForwards.parse("0")
      0
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.format(70)
      "70"
      
      iex> ParrotSip.Headers.MaxForwards.format(0)
      "0"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.decrement(70)
      69
      
      iex> ParrotSip.Headers.MaxForwards.decrement(1)
      0
      
      iex> ParrotSip.Headers.MaxForwards.decrement(0)
      nil
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.MaxForwards.zero?(0)
      true
      
      iex> ParrotSip.Headers.MaxForwards.zero?(1)
      false
  """
