defmodule ParrotSip.Headers.From do
  @moduledoc """
  ...
  def format(from) do
    ...
    uri_part =
      cond do
        is_struct(from.uri, ParrotSip.Uri) ->
          uri = from.uri
          scheme = uri.scheme
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.From.parse("Alice <sip:alice@atlanta.com>;tag=1928301774")
      %ParrotSip.Headers.From{display_name: "Alice", uri: "sip:alice@atlanta.com", parameters: %{"tag" => "1928301774"}}
      
      iex> ParrotSip.Headers.From.parse("<sip:bob@biloxi.com>")
      %ParrotSip.Headers.From{display_name: nil, uri: "sip:bob@biloxi.com", parameters: %{}}
