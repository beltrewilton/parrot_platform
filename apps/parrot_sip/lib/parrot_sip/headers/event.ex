defmodule ParrotSip.Headers.Event do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Event.new("presence")
      %ParrotSip.Headers.Event{event: "presence", parameters: %{}}
      
      iex> ParrotSip.Headers.Event.new("presence", %{"id" => "1234"})
      %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Event.parse("presence")
      %ParrotSip.Headers.Event{event: "presence", parameters: %{}}
      
      iex> ParrotSip.Headers.Event.parse("presence;id=1234")
      %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
  """
  ...
  ## Examples
      ...
      iex> event = %ParrotSip.Headers.Event{event: "presence", parameters: %{}}
      iex> ParrotSip.Headers.Event.format(event)
      "presence"
      
      iex> event = %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
      iex> ParrotSip.Headers.Event.format(event)
      "presence;id=1234"
  """
  ...
  ## Examples
      ...
      iex> event = %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
      iex> ParrotSip.Headers.Event.to_string(event)
      "presence;id=1234"
  """
  ...
  ## Examples
      ...
      iex> event = %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
      iex> ParrotSip.Headers.Event.get_parameter(event, "id")
      "1234"
  ...
  ## Examples
      ...
      iex> event = %ParrotSip.Headers.Event{event: "presence", parameters: %{}}
      iex> ParrotSip.Headers.Event.set_parameter(event, "id", "1234")
      %ParrotSip.Headers.Event{event: "presence", parameters: %{"id" => "1234"}}
  """
