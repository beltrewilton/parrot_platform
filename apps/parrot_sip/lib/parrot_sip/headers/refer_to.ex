defmodule ParrotSip.Headers.ReferTo do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ReferTo.new("sip:alice@example.com")
      %ParrotSip.Headers.ReferTo{display_name: nil, uri: "sip:alice@example.com", parameters: %{}}
      
      iex> ParrotSip.Headers.ReferTo.new("sip:alice@example.com", "Alice")
      %ParrotSip.Headers.ReferTo{display_name: "Alice", uri: "sip:alice@example.com", parameters: %{}}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ReferTo.parse("<sip:alice@example.com>")
      %ParrotSip.Headers.ReferTo{display_name: nil, uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}, parameters: %{}}
      
      iex> ParrotSip.Headers.ReferTo.parse("Alice <sip:alice@example.com>")
      %ParrotSip.Headers.ReferTo{display_name: "Alice", uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}, parameters: %{}}
      
      iex> ParrotSip.Headers.ReferTo.parse("<sip:alice@example.com?Replaces=12345%40example.com%3Bto-tag%3D12345%3Bfrom-tag%3D54321>")
      %ParrotSip.Headers.ReferTo{display_name: nil, uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com", headers: %{"Replaces" => "12345%40example.com%3Bto-tag%3D12345%3Bfrom-tag%3D54321"}}, parameters: %{}}
  """
  ...
  def parse(string) when is_binary(string) do
    ...
    # Parse the URI
    uri =
      case ParrotSip.Uri.parse(uri_str) do
  ...
  ## Examples
      ...
      iex> refer_to = %ParrotSip.Headers.ReferTo{display_name: nil, uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}, parameters: %{}}
      iex> ParrotSip.Headers.ReferTo.format(refer_to)
      "<sip:alice@example.com>"
      
      iex> refer_to = %ParrotSip.Headers.ReferTo{display_name: "Alice", uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}, parameters: %{}}
      iex> ParrotSip.Headers.ReferTo.format(refer_to)
      "Alice <sip:alice@example.com>"
      
      iex> refer_to = %ParrotSip.Headers.ReferTo{display_name: "Alice", uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}, parameters: %{"method" => "INVITE"}}
      iex> ParrotSip.Headers.ReferTo.format(refer_to)
  ...
  def format(refer_to) do
    ...
    uri_part =
      cond do
        is_struct(refer_to.uri, ParrotSip.Uri) ->
          ...
          "<#{ParrotSip.Uri.to_string(uri_with_defaults)}>"
  ...
  ## Examples
      ...
      iex> refer_to = %ParrotSip.Headers.ReferTo{uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com", parameters: %{"transport" => "tcp"}}}
      iex> ParrotSip.Headers.ReferTo.uri_parameters(refer_to)
      %{"transport" => "tcp"}
      
      iex> refer_to = %ParrotSip.Headers.ReferTo{uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com"}}
      iex> ParrotSip.Headers.ReferTo.uri_parameters(refer_to)
      %{}
  """
  ...
  ## Examples
      ...
      iex> refer_to = %ParrotSip.Headers.ReferTo{uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com", headers: %{"Replaces" => "12345%40example.com%3Bto-tag%3D12345%3Bfrom-tag%3D54321"}}}
      iex> ParrotSip.Headers.ReferTo.uri_headers(refer_to)
  ...
  ## Examples
      ...
      iex> refer_to = %ParrotSip.Headers.ReferTo{uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com", headers: %{"Replaces" => "12345%40example.com%3Bto-tag%3D12345%3Bfrom-tag%3D54321"}}}
      iex> ParrotSip.Headers.ReferTo.replaces(refer_to)
  ...
  ## Examples
      ...
      iex> refer_to = %ParrotSip.Headers.ReferTo{uri: %ParrotSip.Uri{scheme: "sip", user: "alice", host: "example.com", headers: %{"Replaces" => "12345%40example.com%3Bto-tag%3D12345%3Bfrom-tag%3D54321"}}}
      iex> ParrotSip.Headers.ReferTo.parse_replaces(refer_to)
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.ReferTo.new_with_replaces("sip:bob@example.com", nil, "call123@example.com", "to-tag-123", "from-tag-456")
      %ParrotSip.Headers.ReferTo{display_name: nil, uri: %ParrotSip.Uri{scheme: "sip", user: "bob", host: "example.com", headers: %{"Replaces" => "call123%40example.com%3Bto-tag%3Dto-tag-123%3Bfrom-tag%3Dfrom-tag-456"}}, parameters: %{}}
  """
  ...
  def new_with_replaces(
    ...
    {:ok, base_uri} = ParrotSip.Uri.parse(uri_str)
