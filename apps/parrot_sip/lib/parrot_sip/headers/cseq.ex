defmodule ParrotSip.Headers.CSeq do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.CSeq.parse("314159 INVITE")
      %ParrotSip.Headers.CSeq{number: 314159, method: :invite}
      
      iex> ParrotSip.Headers.CSeq.parse("1 ACK")
      %ParrotSip.Headers.CSeq{number: 1, method: :ack}
