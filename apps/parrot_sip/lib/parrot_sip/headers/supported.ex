defmodule ParrotSip.Headers.Supported do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.new(["path", "100rel"])
      ["path", "100rel"]
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.parse("path, 100rel")
      ["path", "100rel"]
      
      iex> ParrotSip.Headers.Supported.parse("")
      []
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.format(["path", "100rel"])
      "path, 100rel"
      
      iex> ParrotSip.Headers.Supported.format([])
      ""
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.add(["path"], "100rel")
      ["path", "100rel"]
      
      iex> ParrotSip.Headers.Supported.add(["path", "100rel"], "path")
      ["path", "100rel"]
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.remove(["path", "100rel"], "path")
      ["100rel"]
      
      iex> ParrotSip.Headers.Supported.remove(["path"], "100rel")
      ["path"]
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Supported.supports?(["path", "100rel"], "path")
      true
      
      iex> ParrotSip.Headers.Supported.supports?(["path"], "100rel")
      false
  """
