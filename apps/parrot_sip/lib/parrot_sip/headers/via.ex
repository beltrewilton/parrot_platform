defmodule ParrotSip.Headers.Via do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Via.new("example.com")
  ...
  Delegates to `ParrotSip.Branch.generate/0`.

  ## Examples

      iex> ParrotSip.Headers.Via.generate_branch()
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new_with_branch("example.com")
      iex> ParrotSip.Headers.Via.branch(via) |> String.starts_with?("z9hG4bK")
      true
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com", :udp, 5060, %{"branch" => "z9hG4bKabc"})
      iex> ParrotSip.Headers.Via.format(via)
  ...
  ## Examples
      ...
      iex> via1 = ParrotSip.Headers.Via.new("proxy1.com", :udp, 5060)
      iex> via2 = ParrotSip.Headers.Via.new("proxy2.com", :tcp, 5061)
      iex> ParrotSip.Headers.Via.format_list([via1, via2])
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com")
      iex> ParrotSip.Headers.Via.with_parameter(via, "received", "192.0.2.1")
      %ParrotSip.Headers.Via{parameters: %{"received" => "192.0.2.1"}, ...}
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com", "udp", nil, %{"rport" => "5060"})
      iex> ParrotSip.Headers.Via.get_parameter(via, "rport")
      "5060"
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com")
      iex> via = ParrotSip.Headers.Via.with_parameter(via, "branch", "z9hG4bKabc")
      iex> ParrotSip.Headers.Via.has_parameter?(via, "branch")
      true

      iex> ParrotSip.Headers.Via.has_parameter?(via, "received")
      false
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com", "udp", nil, %{"branch" => "z9hG4bKabc"})
      iex> ParrotSip.Headers.Via.branch(via)
      "z9hG4bKabc"
  """
  def branch(via) do
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com")
      iex> via = ParrotSip.Headers.Via.with_parameter(via, "branch", "z9hG4bKabc123")
      iex> ParrotSip.Headers.Via.rfc3261_compliant_branch?(via)
      true

      iex> via = ParrotSip.Headers.Via.new("example.com")
      iex> via = ParrotSip.Headers.Via.with_parameter(via, "branch", "abc123")
      iex> ParrotSip.Headers.Via.rfc3261_compliant_branch?(via)
      false
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com")
      iex> via = ParrotSip.Headers.Via.with_parameter(via, "branch", "abc123")
      iex> via = ParrotSip.Headers.Via.ensure_rfc3261_branch(via)
      iex> ParrotSip.Headers.Via.branch(via)
      "z9hG4bKabc123"
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com", "udp", nil, %{"received" => "203.0.113.1"})
      iex> ParrotSip.Headers.Via.received(via)
      "203.0.113.1"
  """
  ...
  ## Examples
      ...
      iex> via = ParrotSip.Headers.Via.new("example.com", "udp", nil, %{"rport" => "5060"})
      iex> ParrotSip.Headers.Via.rport(via)
      "5060"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Via.parse("SIP/2.0/UDP server10.biloxi.com:5060;branch=z9hG4bKnashds8")
      %ParrotSip.Headers.Via{protocol: "SIP", version: "2.0", transport: :udp, host: "server10.biloxi.com", port: 5060, host_type: :hostname, parameters: %{"branch" => "z9hG4bKnashds8"}}

      iex> ParrotSip.Headers.Via.parse("SIP/2.0/UDP [2001:db8::1]:5060;branch=z9hG4bK776asdhds")
      %ParrotSip.Headers.Via{protocol: "SIP", version: "2.0", transport: :udp, host: "[2001:db8::1]", port: 5060, host_type: :ipv6, parameters: %{"branch" => "z9hG4bK776asdhds"}}
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Via.topmost(message)
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Via.take_topmost(message)
      {%ParrotSip.Headers.Via{host: "host1", ...}, [rest...]}
