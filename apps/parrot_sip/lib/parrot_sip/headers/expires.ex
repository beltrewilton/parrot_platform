defmodule ParrotSip.Headers.Expires do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.new(3600)
      3600
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.default()
      3600
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.parse("3600")
      3600
      
      iex> ParrotSip.Headers.Expires.parse("0")
      0
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.format(3600)
      "3600"
      
      iex> ParrotSip.Headers.Expires.format(0)
      "0"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.to_string(3600)
      "3600"
      
      iex> ParrotSip.Headers.Expires.to_string(0)
      "0"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.Expires.expired?(expires_time, now)
      false
  ...
  ## Examples
      ...
      iex> now = DateTime.utc_now()
      iex> expires_time = ParrotSip.Headers.Expires.calculate_expiry(3600, now)
  ...
  ## Examples
      ...
      iex> now = DateTime.utc_now()
      iex> expires_time = DateTime.add(now, 3600, :second)
      iex> remaining = ParrotSip.Headers.Expires.remaining_seconds(expires_time, now)
      iex> remaining >= 3599 and remaining <= 3600
      true
      
      iex> now = DateTime.utc_now()
      iex> expires_time = DateTime.add(now, -10, :second)
      iex> ParrotSip.Headers.Expires.remaining_seconds(expires_time, now)
      -10
  """
