defmodule ParrotSip.Headers.RecordRoute do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.RecordRoute.new("sip:proxy.example.com;lr")
      %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.RecordRoute.new("sip:proxy.example.com;lr", "Example Proxy")
      %ParrotSip.Headers.RecordRoute{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.RecordRoute.parse("<sip:proxy.example.com;lr>")
      %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.RecordRoute.parse("Example Proxy <sip:proxy.example.com;lr>")
      %ParrotSip.Headers.RecordRoute{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
      
      iex> ParrotSip.Headers.RecordRoute.parse("\"Complex Name\" <sip:proxy.example.com;lr>;param=value")
      %ParrotSip.Headers.RecordRoute{display_name: "Complex Name", uri: "sip:proxy.example.com;lr", parameters: %{"param" => "value"}}
  """
  ...
  ## Examples
      ...
      iex> record_route = %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy.example.com;lr", parameters: %{}}
      iex> ParrotSip.Headers.RecordRoute.format(record_route)
      "<sip:proxy.example.com;lr>"
      
      iex> record_route = %ParrotSip.Headers.RecordRoute{display_name: "Example Proxy", uri: "sip:proxy.example.com;lr", parameters: %{}}
      iex> ParrotSip.Headers.RecordRoute.format(record_route)
      "Example Proxy <sip:proxy.example.com;lr>"
      
      iex> record_route = %ParrotSip.Headers.RecordRoute{display_name: "Complex Name", uri: "sip:proxy.example.com;lr", parameters: %{"param" => "value"}}
      iex> ParrotSip.Headers.RecordRoute.format(record_route)
  ...
  def format(record_route) do
    ...
    uri_part =
      cond do
        is_struct(record_route.uri, ParrotSip.Uri) ->
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.RecordRoute.parse_list("<sip:proxy1.example.com;lr>, <sip:proxy2.example.com;lr>")
      [
        %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy1.example.com;lr", parameters: %{}},
        %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy2.example.com;lr", parameters: %{}}
      ]
  """
  ...
  ## Examples
      ...
      ...>   %ParrotSip.Headers.RecordRoute{display_name: nil, uri: "sip:proxy2.example.com;lr", parameters: %{}}
      ...> ]
      iex> ParrotSip.Headers.RecordRoute.format_list(record_routes)
