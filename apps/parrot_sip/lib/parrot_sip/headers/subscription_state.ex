defmodule ParrotSip.Headers.SubscriptionState do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.SubscriptionState.new(:active, %{"expires" => "3600"})
      %ParrotSip.Headers.SubscriptionState{state: :active, parameters: %{"expires" => "3600"}}
      
      iex> ParrotSip.Headers.SubscriptionState.new(:terminated, %{"reason" => "timeout"})
      %ParrotSip.Headers.SubscriptionState{state: :terminated, parameters: %{"reason" => "timeout"}}
  """
  @spec new(atom(), map()) :: t()
  ...
  ## Examples
      ...
      iex> ParrotSip.Headers.SubscriptionState.parse("active;expires=3600")
      %ParrotSip.Headers.SubscriptionState{state: :active, parameters: %{"expires" => "3600"}}
      
      iex> ParrotSip.Headers.SubscriptionState.parse("terminated;reason=timeout")
      %ParrotSip.Headers.SubscriptionState{state: :terminated, parameters: %{"reason" => "timeout"}}
  """
  ...
  ## Examples
      ...
      iex> subscription_state = %ParrotSip.Headers.SubscriptionState{state: :active, parameters: %{"expires" => "3600"}}
      iex> ParrotSip.Headers.SubscriptionState.format(subscription_state)
      "active;expires=3600"
      
      iex> subscription_state = %ParrotSip.Headers.SubscriptionState{state: :terminated, parameters: %{"reason" => "timeout"}}
      iex> ParrotSip.Headers.SubscriptionState.format(subscription_state)
  ...
  ## Examples
      ...
      iex> state = ParrotSip.Headers.SubscriptionState.new(:terminated)
      iex> ParrotSip.Headers.SubscriptionState.set_reason("noresource", state)
      %ParrotSip.Headers.SubscriptionState{state: :terminated, parameters: %{"reason" => "noresource"}}
  """
  ...
  ## Examples
      ...
      iex> state = ParrotSip.Headers.SubscriptionState.new(:active)
      iex> ParrotSip.Headers.SubscriptionState.set_expires("3600", state)
      %ParrotSip.Headers.SubscriptionState{state: :active, parameters: %{"expires" => "3600"}}
  """
  ...
  ## Examples
      ...
      iex> state = ParrotSip.Headers.SubscriptionState.new(:terminated)
      iex> ParrotSip.Headers.SubscriptionState.terminated?(state)
      true
