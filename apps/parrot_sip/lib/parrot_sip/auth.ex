defmodule ParrotSip.Auth do
  ...
  ## Examples
      ...
      "atlanta.com"
  """
  @spec create_authorization(atom(), String.t(), map(), String.t(), String.t(), keyword()) :: credentials()
  ...
  """
  @spec validate_authorization(credentials(), atom(), String.t()) :: {:ok, String.t()} | {:error, atom()}
  ...
  defp calculate_response(method, uri, username, password, realm, nonce, cnonce, nc, qop, algorithm) do
    # HA1 calculation
    ha1 = case algorithm do
      "MD5-sess" ->
