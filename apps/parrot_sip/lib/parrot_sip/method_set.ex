defmodule ParrotSip.MethodSet do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.MethodSet.new([:invite, :ack, :bye])
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.standard_methods()
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.dialog_methods()
      iex> ParrotSip.MethodSet.member?(set, :invite)
      true
      iex> ParrotSip.MethodSet.member?(set, :ack)
      true
      iex> ParrotSip.MethodSet.member?(set, :bye)
      true
      iex> ParrotSip.MethodSet.member?(set, :register)
      false
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.new([:invite])
      iex> set = ParrotSip.MethodSet.put(set, :ack)
      iex> ParrotSip.MethodSet.member?(set, :ack)
      true
      
      iex> set = ParrotSip.MethodSet.new()
      iex> set = ParrotSip.MethodSet.put(set, "INVITE")
      iex> ParrotSip.MethodSet.member?(set, :invite)
      true
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.new([:invite])
      iex> set = ParrotSip.MethodSet.put_all(set, [:ack, :bye])
      iex> ParrotSip.MethodSet.member?(set, :ack)
      true
      iex> ParrotSip.MethodSet.member?(set, :bye)
      true
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.delete(set, :ack)
      iex> ParrotSip.MethodSet.member?(set, :ack)
      false
      
      iex> set = ParrotSip.MethodSet.new([:invite, :ack])
      iex> set = ParrotSip.MethodSet.delete(set, "INVITE")
      iex> ParrotSip.MethodSet.member?(set, :invite)
      false
  """
  ...
  ## Examples
      ...
      iex> set1 = ParrotSip.MethodSet.new([:invite, :ack])
      iex> set2 = ParrotSip.MethodSet.new([:bye, :cancel])
      iex> set3 = ParrotSip.MethodSet.union(set1, set2)
      iex> ParrotSip.MethodSet.to_list(set3)
  ...
  ## Examples
      ...
      iex> set1 = ParrotSip.MethodSet.new([:invite, :ack, :bye])
      iex> set2 = ParrotSip.MethodSet.new([:bye, :cancel, :invite])
      iex> set3 = ParrotSip.MethodSet.intersection(set1, set2)
      iex> ParrotSip.MethodSet.to_list(set3)
      [:bye, :invite]
  """
  ...
  ## Examples
      ...
      iex> set1 = ParrotSip.MethodSet.new([:invite, :ack, :bye])
      iex> set2 = ParrotSip.MethodSet.new([:bye, :cancel])
      iex> set3 = ParrotSip.MethodSet.difference(set1, set2)
      iex> ParrotSip.MethodSet.to_list(set3)
      [:ack, :invite]
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.new([:invite, :ack, :bye])
      iex> ParrotSip.MethodSet.to_list(set)
      [:ack, :bye, :invite]
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.new([:invite, :ack, :bye])
      iex> ParrotSip.MethodSet.to_allow_string(set)
      "INVITE, ACK, BYE"
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.from_allow_string("INVITE, ACK, BYE")
      iex> ParrotSip.MethodSet.to_list(set)
      [:ack, :bye, :invite]
  """
  ...
  ## Examples
      ...
      iex> set = ParrotSip.MethodSet.new([:invite, :ack, :bye])
      iex> ParrotSip.MethodSet.size(set)
      3
  """
  ...
  defimpl Enumerable do
    def count(set), do: {:ok, ParrotSip.MethodSet.size(set)}

    def member?(set, method), do: {:ok, ParrotSip.MethodSet.member?(set, method)}

    def reduce(set, acc, fun),
      do: Enumerable.List.reduce(ParrotSip.MethodSet.to_list(set), acc, fun)
  ...
  defimpl Inspect do
    ...
    def inspect(set, opts) do
      concat([
        "#ParrotSip.MethodSet<",
        to_doc(ParrotSip.MethodSet.to_list(set), opts),
        ">"
      ])
    end
  end
