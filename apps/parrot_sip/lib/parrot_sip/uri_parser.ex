defmodule ParrotSip.UriParser do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ParrotSip.UriParser.parse("sip:alice@atlanta.com")
      {:ok, %{scheme: "sip", user: "alice", password: nil, host: "atlanta.com", 
              port: nil, parameters: %{}, headers: %{}}}
      
      iex> ParrotSip.UriParser.parse("sip:alice@atlanta.com:5060;transport=tcp?subject=meeting")
      {:ok, %{scheme: "sip", user: "alice", password: nil, host: "atlanta.com", 
  ...
  ## Examples
      ...
      iex> ParrotSip.UriParser.extract_parameters("transport=tcp;user=phone")
      %{"transport" => "tcp", "user" => "phone"}
      
      iex> ParrotSip.UriParser.extract_parameters("lr")
      %{"lr" => ""}
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.UriParser.extract_headers("subject=project&priority=urgent")
  ...
  ## Examples
      ...
      iex> ParrotSip.UriParser.determine_host_type("example.com")
      :hostname
      
      iex> ParrotSip.UriParser.determine_host_type("192.168.1.1")
      :ipv4
      
      iex> ParrotSip.UriParser.determine_host_type("2001:db8::1")
      :ipv6
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.UriParser.parse_address("alice@atlanta.com:5060")
      {:ok, %{user: "alice", host: "atlanta.com", port: 5060, host_type: :hostname}}
      
      iex> ParrotSip.UriParser.parse_address("atlanta.com")
