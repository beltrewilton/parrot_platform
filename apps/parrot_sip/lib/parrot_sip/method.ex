defmodule ParrotSip.Method do
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.standard_methods()
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.is_standard?(:invite)
      true

      iex> ParrotSip.Method.is_standard?(:custom)
      false
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.parse("INVITE")
      {:ok, :invite}

      iex> ParrotSip.Method.parse("CUSTOM")
      {:ok, :CUSTOM}

      iex> ParrotSip.Method.parse(123)
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.to_string(:invite)
      "INVITE"

      iex> ParrotSip.Method.to_string(:CUSTOM)
      "CUSTOM"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.allows_body?(:invite)
      true

      iex> ParrotSip.Method.allows_body?(:ack)
      true
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.creates_dialog?(:invite)
      true

      iex> ParrotSip.Method.creates_dialog?(:register)
      false
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.requires_contact?(:invite)
      true

      iex> ParrotSip.Method.requires_contact?(:options)
      false
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Method.can_cancel?(:invite)
      true

      iex> ParrotSip.Method.can_cancel?(:ack)
      false
  """
