defmodule ParrotSip.Headers do
  @moduledoc """
  ...
  See `ParrotSip.Branch.generate_for_message/5`.
  """
  ...
  See `ParrotSip.Branch.is_rfc3261_compliant?/1`.
  """
  ...
  See `ParrotSip.Branch.ensure_rfc3261_compliance/1`.
  """
  ...
  See `ParrotSip.Method.to_string/1`.
  """
  ...
  See `ParrotSip.Method.standard_methods/0`.
  """
  ...
  See `ParrotSip.Method.is_standard?/1`.
  """
  ...
  See `ParrotSip.Dialog.is_complete?/1`.
  """
  ...
  See `ParrotSip.Dialog.peer_dialog_id/1`.
  """
  ...
  See `ParrotSip.MethodSet.new/0` and `ParrotSip.MethodSet.new/1`.
  """
  ...
  See `ParrotSip.MethodSet.standard_methods/0`.
  """
  ...
  See `ParrotSip.MethodSet.dialog_methods/0`.
  """
  ...
  See `ParrotSip.MethodSet.to_allow_string/1`.
  """
  ...
  See `ParrotSip.MethodSet.from_allow_string/1`.
  """
