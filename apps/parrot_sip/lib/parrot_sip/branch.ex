defmodule ParrotSip.Branch do
  ...
  ## Examples
      ...
      iex> branch = ParrotSip.Branch.generate()
  ...
  ## Examples
      ...
      iex> ParrotSip.Branch.generate_for_message(:invite, "sip:alice@example.com", "123", nil, "abc@example.com")
      "z9hG4bK" <> _rest
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Branch.is_rfc3261_compliant?("z9hG4bKabc123")
      true

      iex> ParrotSip.Branch.is_rfc3261_compliant?("123456")
      false
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Branch.ensure_rfc3261_compliance("abc123")
      "z9hG4bKabc123"

      iex> ParrotSip.Branch.ensure_rfc3261_compliance("z9hG4bKabc123")
      "z9hG4bKabc123"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Branch.transaction_id("z9hG4bKabc123")
      "abc123"

      iex> ParrotSip.Branch.transaction_id("abc123")
      "abc123"
  """
  ...
  ## Examples
      ...
      iex> ParrotSip.Branch.same_transaction?("z9hG4bKabc123", "z9hG4bKabc123")
      true

      iex> ParrotSip.Branch.same_transaction?("z9hG4bKabc123", "abc123")
      true

      iex> ParrotSip.Branch.same_transaction?("z9hG4bKabc123", "z9hG4bKdef456")
      false
  """
