defmodule ParrotSip.UacHandlerAdapter do
  @moduledoc """
  ...
  alias ParrotSip.{Message, UAC, Uri}
  alias ParrotSip.Headers.{Contact, CSeq}
  require Logger
  ...
  ## Parameters
  - `handler_module` - Module implementing ParrotSip.UacHandler behaviour
  - `handler_init_args` - Arguments to pass to handler's init/1 callback

  ## Returns
  A callback function suitable for use with ParrotSip.UAC.request/3
  """
