defmodule InterAppTest do
  ...
  describe "inter-app communication" do
    ...
    test "each app has its own registry" do
      ...
      # May not be started
      assert Process.whereis(ParrotTransport.Registry) != nil || true
      # May not be started
      assert Process.whereis(ParrotSip.Registry) != nil || true
      # May not be started
      assert Process.whereis(ParrotMedia.Registry) != nil || true
    end
  end
end
